...
if [[ $service == *"DataNode"* ]]; then
    ...
    echo "SERVICE NOT RUNNING.... CHECKING JAVA PREREQUISITES FOR HADOOP "
    # check if java is installed
    service1 = $(java -version)
    if [[ $service1 != *"Java(TM) SE Runtime Environment"*]]; then
    	#check for update
	cd
        sudo apt update
...
"https://javadl.oracle.com/webapps/download/AutoDL?BundleId=239835_230deb18db3e4014bb8e3e8324f81b43"
    ...
    sed 's//JAVA_HOME=*~/opt/jdk1.8.0_221/' hadoop-env.sh
